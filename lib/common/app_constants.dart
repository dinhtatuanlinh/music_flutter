...
const kPadding = {
  0: EdgeInsets.symmetric(horizontal: 32),
...
class ColorConstants {
  ...
  //         ? ColorConstants.primaryColor
  //         : null;
  static const Color primaryColor = Color(0xffFFCB08);
  // static const Color textColor = Color(0xff30424e);
  static const Color colorWhite = Color(0xffffffff);
  static const Color colorBlack = Color(0xff000000);
  // static const Color colorGray = Color(0xfff2f2f2);
  // static const Color colorLightBlue = Color(0xff6dc9f0);
  static const Color colorLightGreen = Color(0xff71ce86);
  // static const Color colorGreen = Color(0xff007A6B);
  static const Color colorRed = Color(0xffff8484);
  // static const Color colorGray2 = Color(0xffededed);
  static const Color correctColor = Color(0xff23AC38);
  static const Color wrongColor = Color(0xffEB5757);
  static const Color mainBackgroundColor = Color(0xffBABABA);
  static const Color borderColor = Color(0xffE0E0E0);
  static const Color textRequirementColor = Color(0xff828282);
}
